...
function makeRay()
{
   ...
   if (frameCount % 60 === 0) 
   {
    ...
    raysGroup.setLifetimeEach(134)
      ...
      raysGroup.overlap(pan1,chargePanel1)
      raysGroup.overlap(pan2,chargePanel2)
      raysGroup.overlap(g_house,IncrTemp)
  
}
//Create function for charge1, charge2 & temp_rise
function chargePanel1(spriteA){
spriteA.remove()
absorbed1+=1
}
function chargePanel2(spriteA){
spriteA.remove()
  absorbed2 +=1

}
function IncrTemp(spriteB){
spriteB.remove()
  temp+=1
